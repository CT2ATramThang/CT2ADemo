<script type="text/javascript">
    ...
    $(document).ready(function() {
        document.title = 'Ford Motor';
    });

</script>
<div class="panel panel-primary">
      <div class="panel-heading">Ford</div>
...
<?php
	...
	$page=$page-1;
	$limit= 12;
	$sql="select * from san_pham where loaisp like 'ford_motor'";
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
		<?php
	$sl= "select * from san_pham where loaisp like 'ford_motor' limit ".$start.",".$limit;
...
<div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
			  ...
			  <ul class="pagination">
			    <?php 
			    	if($page==0){ 
			    		$page=$page+2;
			    		$prev="";
			    		$next= '<a href="?menu=ford_motor&page='.$page.'" aria-label="Next">
			        <span class="fa fa-step-forward"></span>
			      </a>';
			      		$firstpage="";
			      		$endpage= '<a href="?menu=ford_motor&page='.$total.'" aria-label="Final">
			        <span class="fa fa-fast-forward"></span>
			      </a>';
			    	}else if($page>=1){
			    		if($page==$total-1){
			    			$prpage= $page;
			    			$firstpage='<a href="?menu=ford_motor&page=1" aria-label="First">
			        <span class="fa fa-fast-backward"></span>
			      </a>';
			    			$endpage="";
			    			$prev='<a href="?menu=ford_motor&page='.$prpage.'" aria-label="Next">
			...
			for($i=1; $i<=$total; $i++){
				?>
			    <li><a href="?menu=ford_motor&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
			    <?php
			}
		?>
			    <li>
