...
<div class="panel panel-primary" style="border-color: #a94442">
    <div class="panel-heading" style="background-color: #a94442">Đăng ký</div>
	...
	<table class="table">
		...
		<tr>
                    <td align="center"><input type="submit" style="background-color: #999;" class="btn btn-primary" name="submit" value="Đăng ký"></td></form>
			<td align="center"><form action="?menu=exec_dang_ky" action="post"><input type="submit" style="background-color: #999;" class="btn btn-primary" name="cancel" value="Hủy"></form></td>
		</tr>
	</table>
</form>
</div>
