<script type="text/javascript">
    ...
    <div class="panel-heading" style="background-color: #a94442">Thông tin khách hàng</div>
    <div class="panel-body" style="background-color: rgba(0, 0, 0, .075);">
    <p class="alert alert-success">Bạn có thể <a href="?menu=dang_ky">đăng ký</a> làm thành viên để có thể nhận được nhiều ưu đãi hơn từ chúng tôi.<br>Hoặc có thể mua hàng trực tiếp không cần đăng ký thành viên trực tiếp qua form đăng ký bên dưới.</p>
    <p class="alert alert-warning"><strong>Lưu ý: </strong>Các thông tin có dấu <span style="color: red;">(*)</span> đều là bắt buộc.</p>
    <form action="?menu=hoa_don" method="post" role="form" data-toggle="validator">
	<table class="table">
		<tr>
