<%-- 
    Document   : addImageBanner
    Created on : Oct 13, 2020, 10:46:04 AM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Add Image Banner</h2>
                            </header>
                            <div class="panel-body">
                                
                                <form action="${pageContext.request.contextPath}/addImageBanner" enctype="multipart/form-data" class="form-horizontal form-bordered" method="post">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="inputDefault">Image Name</label>
                                        <div class="col-md-6">

                                            <input type="file" name="imgName" required="true" class="form-control" id="inputDefault" />
                                        </div>
                                    </div>
