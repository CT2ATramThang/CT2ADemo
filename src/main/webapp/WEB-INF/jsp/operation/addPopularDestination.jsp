<%-- 
    Document   : addPopularDestination
    Created on : Oct 15, 2020, 3:06:04 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Add Popular Destination</title>
    </head>
    <body>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Add Popular Destination</h2>
                            </header>
                            <div class="panel-body">
                                
                                <mvc:form modelAttribute="popularDestination" action="${pageContext.request.contextPath}/addPopularDestination" class="form-horizontal form-bordered" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="inputDisabled">Place</label>
                                        <div class="col-md-6">
