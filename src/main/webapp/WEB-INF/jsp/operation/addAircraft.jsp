<%-- 
    Document   : forms-basic
    Created on : Sep 21, 2020, 8:35:34 AM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Setup Aircraft</h2>
                            </header>
                            <div class="panel-body">

                                <mvc:form modelAttribute="aircraft" action="${pageContext.request.contextPath}/setupAircraft" class="form-horizontal form-bordered" method="post">
