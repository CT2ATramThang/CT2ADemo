<%-- 
    ...
    Created on : Sep 23, 2020, 8:37:24 AM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Setup Flight</h2>
                            </header>
                            <div class="panel-body">

                                <mvc:form modelAttribute="flight" action="${pageContext.request.contextPath}/setupFlight" class="form-horizontal form-bordered" method="post">
