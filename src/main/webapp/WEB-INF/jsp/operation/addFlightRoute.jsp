<%-- 
    Document   : setupFlightRoute
    Created on : Sep 22, 2020, 10:12:06 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Setup Flight Route</title>
    </head>
    <body>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Setup Flight Route</h2>
                            </header>
                            <div class="panel-body">

                                <mvc:form modelAttribute="flightRoute" action="${pageContext.request.contextPath}/setupFlightRoute" class="form-horizontal form-bordered" method="post">
