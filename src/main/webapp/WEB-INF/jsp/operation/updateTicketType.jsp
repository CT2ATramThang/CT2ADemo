<%-- 
    Document   : updateTicketType
    Created on : Sep 27, 2020, 11:51:56 AM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <mvc:form modelAttribute="ticketType" action="${pageContext.request.contextPath}/updateTicketType" class="form-horizontal form-bordered" method="post">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="inputDefault">Ticket Type ID</label>
                                        <div class="col-md-6">

                                            <mvc:input path="ticketTypeId" readonly="true" class="form-control" id="inputDefault" />
                                        </div>
                                    </div>
                                    <div class="form-group">
