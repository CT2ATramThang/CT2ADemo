<%-- 
    ...
    Created on : Oct 29, 2020, 9:48:50 AM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <mvc:form modelAttribute="users" action="${pageContext.request.contextPath}/updateUsers" class="form-horizontal form-bordered" method="post">
                                      <div class="form-group">
                                        <label class="col-md-3 control-label" for="inputDefault">User Id</label>
                                        <div class="col-md-6">
                                            <mvc:input path="userId" readonly="true" class="form-control" id="inputDefault" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <mvc:input path="enabled"  readonly="true" class="form-control" id="inputDefault" />
                                        </div>
