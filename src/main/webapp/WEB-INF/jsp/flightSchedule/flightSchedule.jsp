...
<html>
    ...
    <body>
        <jsp:include page="flightScheduleHeader.jsp" />
        <div id="colorlib-subscribe" style="background-image: url(${pageContext.request.contextPath}/template/images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
        ...
        <section class="ftco-section" style="background-image: url('${pageContext.request.contextPath}/template/images/images/flight4.jpg');" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                            ...
                            <tbody>
                                <c:forEach var="flight" items="${flightList}">
                                    <tr class="alert" role="alert">
                                        ...
                                        <td>
                                            <div class="button book_button trans_200"><a href="#">${flight.flightRoute.standPrice}</a></div>
                                        </td>
                                        <td>
                                            <div class="button book_button trans_200"><a href="#"><c:out value="${flight.flightRoute.standPrice*ticketClass.exchangeRateClass}"/></a></div>
                                        </td>
        ...
        <jsp:include page="flightScheduleFooter.jsp" />
