<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<div class="contact">			
					<p class="bold">THE WEBSITE IS DESIGN BY SV KHOA CNTT</p>
					<p><i class="fa fa-map-marker"></i>Đà Nẵng 2016</p>
	              	<p><i class="fa fa-envelope"></i>hungpds@gmail.com</p>
	                <p><i class="fa fa-phone"></i>0905 078 055</p>
				</div>	
			</div>
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				<p class="titleft">CONNECT</p>
				<ul class="connect">
					<li><a href="http://facebook.com/phuongdongtuyensinh"><i class="fa fa-facebook"></i></a></li>
